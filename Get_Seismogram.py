...
class Get_Seismogram():
    ...
    def get_source(self, la_s, lo_s, depth, strike, dip, rake, time, M0):
        ...
        source = instaseis.Source(la_s, lo_s, depth_in_m=38438, m_rr=m_rr, m_tt=m_tt, m_pp=m_pp, m_rt=m_rt, m_rp=m_rp, m_tp=m_tp, time_shift=None, sliprate=None, dt=None, origin_time=time)
